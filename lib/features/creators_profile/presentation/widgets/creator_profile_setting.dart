...
import 'package:lyve_chat/features/creators_profile/presentation/widgets/added_bank_accounts.dart';

class CreatorProfileSetting extends StatelessWidget {
  const CreatorProfileSetting({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ProfileOptionsField(hintText: 'Add Bank Details', prefixIcon: const Icon(Icons.account_balance), onPressed: (){
              Get.to(const AddedBankAcc());
            }),
            const SizedBox(height: 16,),
            ProfileOptionsField(
